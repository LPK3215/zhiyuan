  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        {
          path: 'universities',
          name: 'ZhiyuanUniversities',
          component: () => import('../views/zhiyuan/UniversityBrowse.vue'),
          meta: { keepAlive: true, requiresAuth: true }
        },
        {
          path: 'plan',
          name: 'ZhiyuanPlan',
          component: () => import('../views/zhiyuan/PlanView.vue'),
          meta: { keepAlive: false, requiresAuth: true }
        },
        {
          path: 'graph',
          name: 'ZhiyuanGraph',
          component: () => import('../views/zhiyuan/GraphExplore.vue'),
          meta: { keepAlive: false, requiresAuth: true }
        },
        {
          path: 'policy',
